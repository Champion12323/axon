...
const tools: Tool[] = [
  ...
  },
  {
    ...
    name: "AI Replies",
    description:
      "Let Axon understand incoming messages and suggest intelligent replies.",
    icon: Bot,
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex flex-col justify-between gap-6 md:flex-row md:items-end">
            ...
            <p className="max-w-md text-sm leading-6 text-zinc-500">
              Pick a tool and see how Axon can automate the repetitive work
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="text-4xl font-black tracking-tight md:text-6xl">
              ...
              <br />
              Axon brings it together.
            </h2>

            <p className="mt-6 text-zinc-400">
              Connect your social platforms and let Axon turn your data into
              useful decisions.
            </p>
          </div>
      ...
      <section className="relative overflow-hidden px-6 py-28">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-zinc-500">
            Let Axon handle the repetitive work while you focus on creating,
            growing and earning.
          </p>
  ...
  return (
    <div className="mt-8 rounded-3xl bg-zinc-950 p-6 text-white">
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="font-bold">Axon recommends</div>
